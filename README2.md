...
# k8s 사용 준비 (kubectl, eksctl 설치)

<br>

### aws cli 설정, kubectl 설치, EKS 클러스터와 kubectl 연결
...
### eksctl 설치, EKS 클러스터에 IAM OIDC Provider 설정
...
### Helm 설치, Helm 저장소 추가, External Secrets Operator 설치
